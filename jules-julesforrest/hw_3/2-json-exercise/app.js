...
for (i = 0; i < grungeAlbumsJSON.albums.length; i++) {
  console.log("Album: " +  grungeAlbumsJSON.albums[i].name);
  console.log("Artist: " +  grungeAlbumsJSON.albums[i].artist);
  console.log("Units sold: " +  grungeAlbumsJSON.albums[i].unitsSold);
}
//  Album: Album name
//  Artist: Artist name
//  Units sold: 31234
