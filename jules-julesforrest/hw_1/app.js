...
for (beerNumber = 99; beerNumber > -1; beerNumber--) {
  if (beerNumber > 2) {
    ...
    console.log(beerNumber + " bottles of beer on the wall, " + beerNumber + " bottle of beers" + "\n" + "Take one down and pass it around, " + (beerNumber - 1) + " bottle of beer on the wall.");
  }
  else if (beerNumber === 1) {
    console.log(beerNumber + " bottle of beer on the wall, " + beerNumber + " bottle of beer" + "\n" + "Take one down and pass it around, no more bottles of beer on the wall.");
  }
  else {
