...
function rollDice()	 {	
 ...
 console.log("The value of the first die is" + " " +firstDie);
 console.log("The value of the second die is" +" " +secondDie);
 console.log("The total value of the two dice is" +" " +total);
