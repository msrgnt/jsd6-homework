...
var newObject =JSON.parse(grungeAlbumsJSON);
...
for (var single in grungeAlbums.albums) {
  console.log("Album: " + grungeAlbums.albums[single].name)
  console.log("Artist: " + grungeAlbums.albums[single].artist)
  console.log("Units Sold " + grungeAlbums.albums[single].unitsSold)
}
...
var changeGroceryList = JSON.stringify(groceryList)
var convert = JSON.parse(changeGroceryList)
var convertAgain = JSON.stringify(convert)
console.log(changeGroceryList);
console.log(convert);
console.log(convertAgain);
